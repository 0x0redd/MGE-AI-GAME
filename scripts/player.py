...
class Player():
    def __init__(self, game):
        ...
        self.shield = 0
        self.shield_color = brand.BRAND_CYAN
    ...
    def render(self, surf, offset):
        ...
        if self.repulse_time:
            pygame.draw.circle(surf, brand.BRAND_GREEN_GLOW, center, self.repulse_delay * 1000, 8)
        ...
        if self.shield > 0:
            ...
            r1 = pygame.draw.arc(surf, brand.BRAND_BLUE, (self.rect.left-32, self.rect.top-32, 114, 114), c.PI_3, c.TWO_PI_3)
            r2 = pygame.draw.arc(surf, brand.BRAND_BLUE, ext, c.PI_3, c.TWO_PI_3)
            ...
            pygame.draw.arc(surf, brand.BRAND_GREEN, ext, c.TWO_PI_3 - val * c.PI_3, c.TWO_PI_3, 5)
